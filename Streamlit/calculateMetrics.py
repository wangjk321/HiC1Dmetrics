...
class BasePara:
    def __init__(self,data,resolution,chromosome,out_name="noName"):
        self.data = data
...
class InsulationScore(BasePara):
    def __init__(self,data,resolution,chromosome,out_name="InsulationScore",square_size=150000):
        super().__init__(data,resolution,chromosome,out_name)
...
class DirectionalRelativeFreq(BasePara):
    ...
    def __init__(self,data,control_data,resolution,chromosome,out_name="DRF",
                start_distance=0, end_distance=2000000):
        super().__init__(data,resolution,chromosome,out_name)
        self.matrix = data.values
        self.control_data = control_data
        self.control_matrix = control_data.values
